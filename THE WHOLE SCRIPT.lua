...
createTab("Home", {
    ...
    local newAnimations = {
        ...
        ["jerk off"] = 85510928563896, -- Corrected position
        ["backshots"] = 107788763755159, -- Corrected position
    }
...
createTab("Tools", {
	{"Tool A", function() print("Tool A") end},
	{"Tool B", function() print("Tool B") end},
